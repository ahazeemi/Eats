...
import com.example.lenovo.eats.Adapters.PagerAdapterHallManager;
import com.example.lenovo.eats.R;

public class hallManagerOrderBill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final PagerAdapterHallManager pagerAdapter=new PagerAdapterHallManager(getSupportFragmentManager(),tabLayout.getTabCount());
